...
export const GameWastelandLvl1 = () => {
    const [resources, setResources] = useState(() => {
        ...
        const saved = localStorage.getItem('wastelandResources');
        return saved ? parseInt(saved) : 2000;
    });

    // Сохраняем в localStorage при каждом изменении resources
    useEffect(() => {
        localStorage.setItem('wastelandResources', resources.toString());
    }, [resources]);
...
// Здесь происходит атака на юнита противника и проверяется приоритет атаки.
    ...
    return (
        <div className={classes.gamePageWasteland}>
            ...
            {showStoryMessages.outro && <OutroWastelandGame1Lvl setShowStoryMessages={setShowStoryMessages} resources={resources}/>}
